...
<nav class="navbar navbar-expand-lg navbar-custom py-3">
  <div class="container">
    ...
    <!-- Back Button -->
    <a href="tourpackage.php" class="back-btn me-2">
...
<div class="container py-5">
  <div class="package-section">
    ...
    <div class="right-details">
      ...
      <div class="mt-2">
        <a href="download_itinerary.php?pid=<?= $pid ?>" class="btn-download">
          <i class="bi bi-file-earmark-pdf"></i> Download Itinerary (PDF)
        </a>
      </div>
    </div>
      ...
      while ($row = mysqli_fetch_assoc($itinerary_res)) {
        echo "
          <div class='timeline-content'>
            <h5 class='text-primary fw-bold mb-2'>Day $day</h5>
