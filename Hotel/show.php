...
<div class="booking-card">
    <div class="row g-4 align-items-center">
        ...
        <div class="col-md-5 text-center">
            <?php
            // ✅ Fix: Split multiple images and show the first one
            $main_image = '';
            if (!empty($package['image'])) {
                $images = explode(',', $package['image']);
                $main_image = trim($images[0]); // first image
            }
            ?>
            <img src="img/<?php echo htmlspecialchars($main_image); ?>" class="package-img mb-3" alt="Package Image">
            <h5 class="fw-bold"><?php echo htmlspecialchars($package['title']); ?></h5>
            <h6 class="text-success mt-2"><b>Price:</b> ₹<?php echo htmlspecialchars($package['price']); ?></h6>
        </div>
