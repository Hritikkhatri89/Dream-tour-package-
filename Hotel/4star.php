...
<head>
    ...
    <title>4 Star Hotels for <?php echo htmlspecialchars($package['title']); ?></title>
...
<div class="container my-5">
    <h2 class="text-center mb-4 text-primary fw-bold">🏨 4 Star Hotels for: <?php echo htmlspecialchars($package['title']); ?></h2>
    <hr class="mb-5">
...
<div id="carousel<?php echo $hotel['id']; ?>" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carousel<?php echo $hotel['id']; ?>" data-bs-slide="next">
    <span class="carousel-control-next-icon"></span>
        ...
        <?php endwhile; ?>
    <?php else: ?>
        <div class="alert alert-warning text-center w-100">No 4 Star Hotels available for this package yet.</div>
    <?php endif; ?>
    </div>
